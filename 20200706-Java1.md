...
1. [Java JDK Download](https://www.oracle.com/java/technologies/javase-downloads.html)
...
![function definition](./images/function.png)
* Markdown md文件的制作，制作课堂笔记
![好记性不如烂笔头儿](./images/烂笔头儿.png)
* 显示标题，子标题 #, ##
* 显示 tablet *，1
* 显示命令行
[Keyboard key name](https://jobs.mo.gov/sites/jobs/files/computer-keyboard-explanations.pdf)
![keyboard](./images/keyboard-windows.jpg)
![Apple keyboard](./images/keyboard-apple.jpg)
space
:
